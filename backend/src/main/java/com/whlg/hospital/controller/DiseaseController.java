...
public class DiseaseController {
    ...
    public DiseaseController(MedicalResourceService medicalResourceService) {
    ...
    public R<PageResult<Map<String, Object>>> list(@RequestParam(required = false) Integer page,
        ...
        return R.ok(medicalResourceService.listDiseases(page, pageSize, departmentId, keyword));
    }

    @GetMapping("/{id}")
    public R<Map<String, Object>> detail(@PathVariable("id") Long id) {
        return R.ok(medicalResourceService.getDiseaseDetail(id));
    }
}